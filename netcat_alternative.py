...
def usage():
	...
	print "echo 'ABCDEFGHI' | ./netcat_alternative.py -t 192.168.11.12 -p 153"
	sys.exit(0)
...
def main():
	...
	# are we going to listen ot just send data from stdin?
...
def server_loop():	
	...
	# if no target is defined, we listed on all interfaces
	if not len(target):
		target = "0.0.0.0"
